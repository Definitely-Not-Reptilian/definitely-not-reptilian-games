...
- [Player](#player)
  - [Character Creation](#character-creation)
    - [Step 1 - Standard Investigator Deck](#step-1---standard-investigator-deck)
    - [Step 2 - Customisation](#step-2---customisation)
    - [Step 3 - Perform "Add to deck" instructions](#step-3---perform-add-to-deck-instructions)
    - [Step 4 - Construct Tableau](#step-4---construct-tableau)
    - [Step 5 - Construct Deck](#step-5---construct-deck)
    - [Step 6 - Name](#step-6---name)
    - [Step 7 - Construct the upgrade deck](#step-7---construct-the-upgrade-deck)
  - [How to Play](#how-to-play)
    - [Zones](#zones)
    - [Basic moves](#basic-moves)
    - [Abilities](#abilities)
    - [Checking](#checking)
    - [Running out of cards](#running-out-of-cards)
...
The investigators must find the source of Evil, discover it's weakness and then end it for good. This may not require killing the Evil, simply locking it away, preventing it from being summoned, or generally 'stopping' it will often be enough. Sometimes, killing Evil wont be enough. The investigators may have to salt and burn the earth so no Evil can grow again.
...
Most aren't even aware of the otherworldly forces eager to devour and mutate our existence. It is a well kept secret, and you intend to keep it that way.\
How?\
...
#### Step 1 - Standard Investigator Deck:
Each player begins by constructing a standard Investigator deck containing 10 ![Base](/img/drawn-to-evil/base.png) Base cards:
...
- Draw 2 x each of ![Background](/img/drawn-to-evil/background.png) Background, ![Trait](/img/drawn-to-evil/trait.png) Trait and ![Role](/img/drawn-to-evil/role.png) Role cards. Keep 1 of each. Think about the combination that you think would fight Evil best.
- Draw 4 x ![Ability](/img/drawn-to-evil/ability.png) Ability cards. Keep 2. Think about the kind of moves your investigator would have.

#### Step 3 - Perform "Add to deck" instructions:

- Complete any ![Add to deck](/img/drawn-to-evil/add.png) Add to deck instructions on your Background and Trait cards (these are the instructions at the bottom of the cards). This may require you to remove base ![Base](/img/drawn-to-evil/base.png) cards to your starting deck answer a question about your past.

#### Step 4 - Construct tableau:
- Your ![Ability](/img/drawn-to-evil/ability.png) Ability cards and ![Role](/img/drawn-to-evil/role.png) Role card start in your tableau (layed out in front of you) ready to be used.

#### Step 5 - Construct deck:
- All other cards including your ![Background](/img/drawn-to-evil/background.png) Background and ![Trait](/img/drawn-to-evil/trait.png) Trait cards are shuffled together to form your deck.

#### Step 6 - Name:
- Give your investigator a name! Think about the name that sums up who you have constructed from the earlier steps.

#### Step 7 - Construct the upgrade deck:
...
When you attempt to do something dangerous, difficult or with a chance of failure, name an appropriate Basic Move or Ability card in your tableau. The Game Master will tell you if that is appropriate and get you to make a "Check" to see how successful your action is.

#### Zones:
Your cards exist in 3 main zones. Your deck, discard pile, and your tableau. You deck is face down, and your discard and tableau are face up.
...
#### Abilities:
Instead of using the basic moves, you can also use the abilities in your tableau. Once the Ability cards are used, they should go in your discard. You can use these abilities at any time.
Some Abilities allow you to use different Aspects when Checking. You can decide to use these abilities even after drawing the check cards, effectively turning your failure into a success by using a different total on the same cards.
...
- Draw an ![Ability](/img/drawn-to-evil/ability.png) Ability card. Put it in you tableau.\
- Draw a card with a ![Play card](/img/drawn-to-evil/play.png) Play Card rule on it. You should follow the instructions immediately.
- Draw 3 or more cards marked with a skull ![Skull](/img/drawn-to-evil/skull.png). Something bad happens. Refer to the [Death](#death) section of the rules for this.
...
Whenever your deck is empty, even in the middle of a check, shuffle all cards in your discard pile and they becomes your new deck.
...
- Tell you their name.
- Read and complete the ![Add to deck](/img/drawn-to-evil/add.png) prompts on their Background ![Background](/img/drawn-to-evil/background.png) and Trait ![Trait](/img/drawn-to-evil/trait.png) cards. Usually these ask the player to describe an event in the investigators past.
...
- **Investigator deck** - Most cards begin here; this is where you draw from when performing a check.
- **Tableau** - Cards on the table in front of you form your ready to use abilities. 
- **Discard pile** - After a card is drawn for a check or an Ability card is used, they are placed here face up. When your deck runs out of cards, shuffle your discard pile and these cards become your new investigator deck.
...
### Death
If 3 or more Injury and/or Shock cards are drawn during a single check, that investigator is marked for death. Injury and Shock cards are marked with a ![Skull](/img/drawn-to-evil/skull.png).
Before the end of the session, all investigators marked must perish. It is up to the Game Master and player to decide how exactly their death or insanity manifests.
